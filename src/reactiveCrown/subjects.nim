...
template defineBasicSubjectConverters*(Type: typedesc): untyped =
  ...
  converter toObservable*[T](sbj: `Type`[T]): Observable[T] = sbj.sbj.observable
  converter toObserver*[T](sbj: `Type`[T]): Observer[T] =     sbj.sbj.ober
...
type OperatorSubject*[T] = ref object
  sbj: Subject[T]

OperatorSubject.defineBasicSubjectConverters

proc newOperatorSubject*[T](): OperatorSubject[T] =
  var subject = OperatorSubject[T](sbj: newSubject[T]())
